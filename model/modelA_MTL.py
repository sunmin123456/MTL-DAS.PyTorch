...
class MTL_Net(nn.Module):
    """
    Implementation of the two-level MTL network (Model A in the paper)
    Task 1: Radial distance discrimination, Task 2: Event type recognition
    """
    ...
    def forward(self, x):
        ...
        pred2 = self.task2pool(a_4[1]).squeeze(2).squeeze(2)
